    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
         ...
         <?php if(session('locale') == 'ar'): ?>
          <a class="link-secondary" href="<?php echo url('language?lang=en'); ?>"><?php echo trans('main.ENGLISH'); ?></a>
          <?php else: ?>
          <a class="link-secondary" href="<?php echo url('language?lang=ar'); ?>"><?php echo trans('main.ARABIC'); ?></a>
          <?php endif; ?>
