...
?>
                ...
                <form method="post" action="{{url('comment/store')}}">
 					...
 					<div class="mt-3 d-flex flex-row align-items-center p-3 form-color">
 						<input type="text" class="form-control" {{ !empty(get_error('name'))?'is-invalid':'' }}  name="name" placeholder="{{ trans('main.NAME') }}" />
 					...
 					<div class="mt-3 d-flex flex-row align-items-center p-3 form-color">
 						...
 						<textarea class="form-control" {{ !empty(get_error('comment'))?'is-invalid':'' }}
                         name="comment"
